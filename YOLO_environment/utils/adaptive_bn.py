...
from utils.general import labels_to_class_weights, init_seeds,check_dataset, check_git_status, check_img_size
from utils.loss import ComputeLoss
from utils.torch_utils import is_parallel, intersect_dicts, select_device, \
...
class AdaptiveBNEval(object):
    ...
    def __call__(self, compact_model):
        ...
        results, _, _ = test.run(self.data_dict,
